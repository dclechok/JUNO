...
function ManageUsers({ accountLogged }){
    ...
    return (
        <>
          ...
          <div>
        <span style={{color: "black"}}>[<button className={buttonStyle.view} id="view" onClick={handleClick} >View Users</button>]</span>&nbsp;
        <span style={{color: "black"}}>[<button className={buttonStyle.create} id="create" onClick={handleClick} >Create User</button>]</span>
