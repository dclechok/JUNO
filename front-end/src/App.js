          ...
          <Router>
            ...
            <div className='dashboard-main'>
              <div className='dashboard-menu'>
                <NavLinks accountLogged={accountLogged} loadAssets={loadAssets} setLoadAssets={setLoadAssets} />
                <LoginBar currentAcct={currentAcct} setCurrentAcct={setCurrentAcct} />
              </div>
            </div>
            <div className="main-display-container">
              <Routes>
                <Route exact path="/" element={<Dashboard assetList={assetList} loadAssets={loadAssets} setLoadAssets={setLoadAssets} />}></Route>
                <Route
                  exact
                  path="/asset_list"
                  element={
